...
// class SellerProductDetailsPage extends StatelessWidget {

//   @override
//   Widget build(BuildContext context) {
//     final colorScheme = Theme.of(context).colorScheme;
//     Products product = ModalRoute.of(context)!.settings.arguments as Products;
//     final sellerProductDetailsBloc =
//         SellerProductDetailsBloc(SellerProductService());

//     return BlocProvider(
//       create: (context) => SellerProductDetailsBloc(SellerProductService()),
//       child: BlocBuilder<SellerProductDetailsBloc, SellerProductDetailsState>(
//         builder: (context, state) {
//           int _currentIndex = 0;
//           if (state is ProductImageIndexChangedState) {
...
//             body: _buildBodyContents(colorScheme, product),
//           );
//         },
//       ),
//     );
...
//   Padding _buildBodyContents(ColorScheme colorScheme, Products product) {
//     return Padding(
