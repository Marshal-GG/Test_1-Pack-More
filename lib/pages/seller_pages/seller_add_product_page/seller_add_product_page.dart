...
class _AddProductPageState extends State<AddProductPage> {
  ...
  Future<void> _fetchCategories() async {
    ...
    setState(() {
      _categories = [
        'No Label',
        ...snapshot.docs.map((doc) => doc['name'].toString()),
        'Custom'
      ];
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<DrawerSelectionState>(
      builder: (context, drawerSelection, child) {
        return Scaffold(
          appBar: buildAppBar(colorScheme, categoryValue),
                      ...
                      title: DropdownButtonFormField(
                        ...
                        onChanged: (newValue) async {
                          if (newValue == 'Custom') {
                            ...
                            if (updatedCategoryValue.isNotEmpty) {
                              setState(() {
                                categoryValue = updatedCategoryValue;
                              });
                            }
                          } else {
                            setState(() {
        ...
        FilledButton(
          onPressed: () {
            if (_formKey.currentState!.validate()) {
              _addProduct(context, colorScheme, categoryValue);
            }
          },
          style: FilledButton.styleFrom(
            shape: RoundedRectangleBorder(
  ...
  Future<String> _showCustomCategoryDialog(
      BuildContext context, categoryValue, ColorScheme colorScheme) async {
                ...
                child: TextFormField(
                  ...
                  onChanged: (newValue) {
                    setState(() {
                      ...
                      isOkButtonEnabled = newCategoryName.isNotEmpty;
                    });
                  },
                  decoration: InputDecoration(
    ...
    return newCategoryName.isNotEmpty ? newCategoryName : categoryValue;
  }
}
